...
LATE_REMAINING_TURNS = 80          # tuned: earlier late-game
VERY_LATE_REMAINING_TURNS = 25
TOTAL_WAR_REMAINING_TURNS = 65     # tuned: earlier total war push
...
EXPOSED_PLANET_VALUE_MULT = 2.3    # tuned: punish exposed enemies harder

# NEW: weakest enemy targeting multipliers
WEAKEST_ENEMY_VALUE_MULT_4P = 1.8   # tuned: stronger 4P elimination focus
WEAKEST_ENEMY_VALUE_MULT_2P = 1.1  # tuned: less relevant in 1v1
...
FOUR_PLAYER_TARGET_MARGIN = 1       # tuned: even more efficient in 4P
...
STATIC_TARGET_SCORE_MULT = 1.28
EARLY_STATIC_NEUTRAL_SCORE_MULT = 1.35
...
REINFORCE_MAX_SOURCE_FRACTION = 0.80
...
REAR_SOURCE_MIN_SHIPS = 12
REAR_DISTANCE_RATIO = 1.25
REAR_STAGE_PROGRESS = 0.78
REAR_SEND_RATIO_TWO_PLAYER = 0.70
REAR_SEND_RATIO_FOUR_PLAYER = 0.68  # tuned: more forwarding to front
...
THREE_SOURCE_PLAN_PENALTY = 0.90

PROACTIVE_DEFENSE_HORIZON = 12
PROACTIVE_DEFENSE_RATIO = 0.22      # tuned: less defensive, more attack
MULTI_ENEMY_PROACTIVE_HORIZON = 14
MULTI_ENEMY_PROACTIVE_RATIO = 0.25  # tuned: less defensive in 4P
...
CRASH_EXPLOIT_MIN_TOTAL_SHIPS = 5   # tuned: exploit even smaller crashes
CRASH_EXPLOIT_ETA_WINDOW = 4        # tuned: even wider crash window
CRASH_EXPLOIT_POST_CRASH_DELAY = 1

LATE_IMMEDIATE_SHIP_VALUE = 0.75
WEAK_ENEMY_THRESHOLD = 140          # tuned: detect weak enemies much earlier
ELIMINATION_BONUS = 70.0            # tuned: very strong elimination drive

BEHIND_DOMINATION = -0.20
AHEAD_DOMINATION = 0.15
FINISHING_DOMINATION = 0.20
FINISHING_PROD_RATIO = 1.15
AHEAD_ATTACK_MARGIN_BONUS = 0.18
BEHIND_ATTACK_MARGIN_PENALTY = 0.02
