...
try:
    ...
    _WRAPPER_DIR = "/Users/derekwang/Documents/GitHub/orbit-wars/bots/mine/alphaow_ow"
...
def _ensure():
    ...
    # Focused single-target candidate generator: one plan per won't-own-at-
    # end-of-extrapolation target, with attack orders + healing orders from
    # rear support planets to the frontline. See apollo_bridge::focused_candidates.
    env["OW_FOCUSED_CANDIDATES"] = "1"
