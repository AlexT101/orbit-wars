...
/// per-turn comet gate ([`crate::apollo::blockers::comet_blocks_path`]) handles them.
...
pub enum InvariantVerdict {
    ...
    /// gates the carried base): solve normally with [`crate::apollo::blockers::aim_with_prediction`].
    SingleSolve,
    /// Unknown (cache miss) and potentially cacheable: solve the comet-free base
    /// with [`crate::apollo::blockers::aim_ignoring_comets`] and feed it to
...
pub struct Entity {
    ...
    /// it lets [`crate::apollo::blockers::comet_blocks_path`] reject, in O(1) with no
    ...
    /// contiguous band, which [`crate::apollo::blockers::blocked_on_path`] binary-searches
...
pub struct EntityCache {
    ...
    /// ([`crate::apollo::blockers::blocked_on_path`] / `cone_clear_impossible`) iterate
    ...
    /// ([`crate::apollo::blockers::comet_blocks_path`]) iterates only comets instead of
...
impl EntityCache {
    ...
    /// [`crate::apollo::blockers::aim_ignoring_comets`] `comet_free` base (the shot clear
    ...
    /// ray, identical to the one [`crate::apollo::blockers::shot_blocked_exact`] sweeps.
