...
use crate::apollo::constants::{CENTER, LAUNCH_CLEARANCE, MAX_SHIP_SPEED, SUN_RADIUS};
...
use crate::apollo::sim_probe::SimProbe;
pub use crate::apollo::sim_probe::ArrivalEvent;
...
pub fn fleet_speed(ships: i64) -> f64 {
    crate::apollo::engine::fleet_speed(ships.max(1), MAX_SHIP_SPEED)
}
...
/// [`crate::apollo::blockers`]: lead the target with Newton iteration, then reject
...
pub fn count_players(planets: &[Planet], fleets: &[Fleet]) -> usize {
    use crate::apollo::constants::MAX_PLAYERS;
