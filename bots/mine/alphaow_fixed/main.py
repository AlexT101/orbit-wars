...
try:
    ...
    _WRAPPER_DIR = "/Users/derekwang/Documents/GitHub/orbit-wars/bots/mine/alphaow_fixed"
_ALPHAOW_DIR = os.path.abspath(os.path.join(_WRAPPER_DIR, "..", "alphaow"))

# Fixed-extrapolation XGB model retrained 2026-05-30. Must be paired with
# ALPHAOW_EXTRAP_FIX=1 (set below) so the deployed bot's extrapolate_fleets
# matches the training feature extraction.
_DEFAULT_VALUE_NET = os.path.join(_ALPHAOW_DIR, "train/weights/xgb_top10_d6_fixed.json")
...
def _ensure():
    ...
    # the bot's extrapolate_fleets uses the buggy combat that the model
    # was NOT trained on — silently mispredicting.
