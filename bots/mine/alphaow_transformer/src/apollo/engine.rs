...
// pyo3 bindings (`RustEngineCore`, `as_py`/`snapshot_py`/`assemble`, and the
// `parse_py_*`/`configuration_*_py` helpers) were stripped when vendoring into
// alphaow: this module is used purely for in-process forward simulation, with
