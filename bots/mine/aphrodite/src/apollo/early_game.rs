...
//! first [`early_game_end()`](crate::apollo::constants::early_game_end) steps.
//!
//! The greedy pipeline in [`crate::apollo::strategy`] commits the best-scoring
...
//! wholesale.
//!
//! The phase gate ([`early_game_end()`](crate::apollo::constants::early_game_end)) is a hard stop on *running* the DFS, not
...
//! later hops would launch at/after [`early_game_end()`](crate::apollo::constants::early_game_end) is handed to the greedy
...
/// scoring horizon ([`early_game_score_horizon()`](crate::apollo::constants::early_game_score_horizon)), not the shorter projection
...
struct Search {
    window: i64,
    /// Economic horizon used for capture *value* ([`early_game_score_horizon()`](crate::apollo::constants::early_game_score_horizon),
