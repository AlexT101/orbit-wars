...
ROOT = Path(__file__).resolve().parents[4]   # bots/mine/aphrodite/train/<this> -> orbit-wars
...
def run_one(me_bot: str, opp_bot: str, seed: int, env_overrides: dict, swap: bool):
    ...
    # Apply env overrides only to aphrodite's slot. The match runner loads both
...
def main():
    ...
    p.add_argument("--me", default="aphrodite")
