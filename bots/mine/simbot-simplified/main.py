"""
Orbit Wars - simbot-simplified

A thin Python wrapper that delegates the entire turn to a native Rust extension
(`simbot_simplified_native`). The Rust side owns all bot state — turn counter,
...
# Locate the directory containing simbot_simplified_native.*.so. Both Kaggle's runner and
...
import simbot_simplified_native
...
_BOT = simbot_simplified_native.Bot()
