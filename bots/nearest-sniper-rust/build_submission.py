"""
Build a Kaggle-ready submission bundle for rust_bot.
...
Requires Docker. Output: bots/rust_bot/submission.tar.gz
"""
...
def main() -> int:
    ...
    wheels = sorted(
        glob(str(HERE / "target" / "wheels" / "rust_bot_native-*-abi3-manylinux*.whl")),
    ...
    print(
        "Submit with:\n"
        f"  kaggle competitions submit orbit-wars -f {bundle} -m 'rust_bot v1'"
    )
    return 0
