...
SEED = 123
DEVICE = os.environ.get("IL_DEVICE", "cuda")
MODEL = os.environ.get("IL_MODEL", "entity_transformer_ngpt_action_features")
HIDDEN = int(os.environ.get("IL_HIDDEN", "128"))
TRANSFORMER_LAYERS = int(os.environ.get("IL_TRANSFORMER_LAYERS", "3"))
TRANSFORMER_HEADS = int(os.environ.get("IL_TRANSFORMER_HEADS", "4"))
EPOCHS = 1_000_000
BATCH_SIZE = 512
...
WANDB_RUN_NAME = os.environ.get("IL_WANDB_RUN_NAME", "osteo-bc-transformer")
DATASET_NAME = os.environ.get("IL_DATASET_NAME", "osteo_top20_2p_winners")
