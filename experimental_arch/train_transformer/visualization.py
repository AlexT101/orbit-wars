...
<body>
  ...
  <main class="grid">
    ...
    {_chart(metrics, "Reward Components", ["reward_terminal", "reward_terminal_time", "reward_production_income", "reward_launch_penalty"], colors, smooth=8, vlines=ppo_markers)}
    <section class="panel">
